...
namespace CibraryEngine
{
	...
	struct PhysicsWorld::Imp
	{
		...
		Imp() : rigid_bodies(), shape_bodies(), gravity(0, -9.8f, 0), internal_timer(), timer_interval(1.0f / 60.0f) { }
		~Imp()
		{
		...
		bool RemoveRigidBody(RigidBody* body)
		{
			...
			boost::unordered_set<RigidBody*>::iterator found = rigid_bodies.find(body);
