...
namespace CibraryEngine
{
	...
	unsigned short int ReadUInt16(istream& stream) { return (ReadByte(stream) << 8) | (ReadByte(stream) << 0); }
	...
	unsigned int ReadUInt32(istream& stream) { return (ReadByte(stream) << 24) | (ReadByte(stream) << 16) | (ReadByte(stream) << 8) | (ReadByte(stream) << 0); }
	...
	unsigned short int FlipUInt16(unsigned short int input) { return (((input >> 8) & 0xFF) << 0) | (((input >> 0) & 0xFF) << 8); }
	unsigned int FlipUInt32(unsigned int input) { return (((input >> 24) & 0xFF) << 0) | (((input >> 16) & 0xFF) << 8) | (((input >> 8) & 0xFF) << 16) | (((input >> 0) & 0xFF) << 24); }
