...
namespace InverseKinematics
{
	 ...
	 * StepPose methods
	 */
	StepPose::StepPose(Bone* end, Bone* base, ModelPhysics* mphys) : chain(new IKChain(end, base, mphys)), arrive_time(-1), arrived(true), lifting(false), dood_vel()
	{
	...
	void StepPose::UpdatePose(TimingInfo time) { SeekPosition(time); }
