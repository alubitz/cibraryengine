...
namespace Test
{
	...
	public:
		...
		void UpdatePose(TimingInfo time)
		{
			...
			SetBonePose(Bone::string_table["torso 1"],		Vec3(pitch * 0.35f,	0, 0),	Vec3());
			SetBonePose(Bone::string_table["torso 2"],		Vec3(pitch * 0.35f,	0, 0),	Vec3());
			SetBonePose(Bone::string_table["head"],			Vec3(pitch * 0.3f,	0, 0),	Vec3());
