...
namespace Test
{
	...
	Mat4 DefaultWeapon::GetInitialXform()
	{
		return owner->RigidBodyForNamedBone("r hand")->GetTransformationMatrix()
			* Mat4::FromPositionAndOrientation(Vec3(-0.959f,  1.098f,  0.077f), Quaternion::FromRVec(-Vec3(-1.27667f, 0.336123f, 0.64284f)))
			* Mat4::Translation(-Vec3(0.000f, -0.063f, -0.152f));
	}
};
