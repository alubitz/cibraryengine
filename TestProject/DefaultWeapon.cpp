...
namespace Test
{
	...
	DefaultWeapon::DefaultWeapon(TestGame* game_state, Dood* owner, UberModel* gun_model, VTNModel* mflash_model, VTNModel* shot_model, GlowyModelMaterial* mflash_material, GlowyModelMaterial* shot_material, SoundBuffer* fire_sound, SoundBuffer* chamber_click_sound, SoundBuffer* reload_sound) :
