...
add_symmetric_joints(joints, bones,	"arm 2",	"hand",		ba.createVector(0.82,	1.25,	0.01),	nil, {	ba.createVector(11.6,	22.0,	0.0), ba.createVector(0, 0, -1) },	ba.createVector(-0.44,	-0.44,	-0.1),	ba.createVector(0.175,	1.57,	0.1))
