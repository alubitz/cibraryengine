...
P.add_symmetric_joints(joints, bones,	"torso 2",	"shoulder",	ba.createVector(0.25,	1.57,	-0.16),	nil, nil,										ba.createVector(-0.1,	-0.1,	-0.1),	ba.createVector(0.1,	0.1,	0.1))
P.add_symmetric_joints(joints, bones,	"shoulder",	"arm 1",	ba.createVector(0.28,	1.54,	-0.05),	nil, nil,										ba.createVector(-1.5,	-1.5,	-1.5),	ba.createVector(1.5,	1.5,	1.5))
P.add_symmetric_joints(joints, bones,	"arm 1",	"arm 2",	ba.createVector(0.53,	1.4,	-0.06),	nil, hand_axes,									ba.createVector(-2.618,	-0.02,	-1.0),	ba.createVector(0.02,	0.02,	1.0))
