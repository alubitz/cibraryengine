...
P.add_single_bone(bones,		"pelvis",	mass, { P.sphere(0.09,	1.08,	-0.02,	0.20),	P.sphere(-0.09,	1.08,	-0.02,	0.20) } )
P.add_single_bone(bones,		"torso 1",	mass, { P.sphere(0.13,	1.28,	0.06,	0.1),	P.sphere(-0.13,	1.28,	0.06,	0.1),	P.sphere(0.0,	1.37,	-0.09,	0.16),	P.sphere(0.0,	1.28,	-0.06,	0.16) } )
P.add_single_bone(bones,		"torso 2",	mass, { P.sphere(0.0,	1.65,	-0.2,	0.2),	P.sphere(0.14,	1.50,	0.09,	0.16),	P.sphere(-0.14,	1.50,	0.09,	0.16) } )
...
P.add_symmetric_bones(bones,	"arm 1",	mass, { P.sphere(0.30,	1.51,	-0.04,	0.14),	P.sphere(0.53,	1.4,	-0.06,	0.11) } )
...
P.add_symmetric_joints(joints, bones,	"arm 1",	"arm 2",	ba.createVector(0.53,	1.4,	-0.04),	nil, hand_axes,									ba.createVector(-2.0,	-0.4,	-1.0),	ba.createVector(0.4,	0.4,	1.0))
P.add_symmetric_joints(joints, bones,	"arm 2",	"hand",		ba.createVector(0.84,	1.25,	0.02),	nil, hand_axes,									ba.createVector(-1.5,	-1.0,	-1.0),	ba.createVector(1.5,	1.0,	1.0))
...
P.add_symmetric_joints(joints, bones,	"leg 1",	"leg 2",	ba.createVector(0.19,	0.65,	0.01),	nil, {	ba.createVector(28.2,	2.5,	0.0) },	ba.createVector(-0.02,	-0.02,	-0.02),	ba.createVector(1.745,	0.02,	0.02))
