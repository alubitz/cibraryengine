...
Bone(b,     "pelvis",   0 * M, { Sphere( 0.00, 1.08,  0.03, 0.18), Sphere( 0.14, 1.07, -0.07, 0.16), Sphere(-0.14, 1.07, -0.07, 0.16) } )
...
Joint(j, b,     "pelvis",   "torso 1",  Vec3(0.00, 1.34, -0.10), nil, nil,       Vec3(-0.55, -0.5,  -0.45), Vec3(0.5,   0.5,  0.45))
Joint(j, b,     "torso 1",  "torso 2",  Vec3(0.00, 1.57,  0.00), nil, nil,       Vec3(-0.55, -0.5,  -0.45), Vec3(0.5,   0.5,  0.45))
Joint(j, b,     "torso 2",  "head",     Vec3(0.00, 1.73,  0.00), nil, nil,       Vec3(-0.4,  -1.2,  -0.26), Vec3(0.3,   1.2,  0.26))
SymJoints(j, b, "torso 2",  "shoulder", Vec3(0.22, 1.65, -0.16), nil, nil,       Vec3(-0.25, -0.25, -0.25), Vec3(0.25,  0.25, 0.25))
SymJoints(j, b, "shoulder", "arm 1",    Vec3(0.30, 1.51, -0.04), nil, nil,       Vec3(-1.8,  -1.8,  -1.0 ), Vec3(1.8,   1.0,  0.8 ))
