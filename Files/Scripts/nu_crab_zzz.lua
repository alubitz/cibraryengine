...
U.add_symmetric_bones(bones,	"leg a 3",		"leg a 2",		ba.createVector(	0.470,	0.694,	0.993	) )
U.add_symmetric_bones(bones,	"leg a point",	"leg a 3",		ba.createVector(	0.288,	0.0,	1.293	) )U.add_symmetric_bones(bones,	"leg b 1",		"carapace",		ba.createVector(	0.635,	0.980,	0.022	) )
U.add_symmetric_bones(bones,	"leg b 2",		"leg b 1",		ba.createVector(	1.043,	0.742,	0.164	) )
U.add_symmetric_bones(bones,	"leg b 3",		"leg b 2",		ba.createVector(	1.631,	1.050,	0.339	) )
U.add_symmetric_bones(bones,	"leg b point",	"leg b 3",		ba.createVector(	2.068,	0.0,	0.470	) )
